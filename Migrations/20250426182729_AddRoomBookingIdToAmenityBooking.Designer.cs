...
namespace HotelBackend.Migrations
{
    ...
    [Migration("20250426182729_AddRoomBookingIdToAmenityBooking")]
    partial class AddRoomBookingIdToAmenityBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelBackend.Models.AdditionalGuest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("additional_guest", "core");
                });
            ...
            modelBuilder.Entity("HotelBackend.Models.AmenityPayment", b =>
                {
                    ...
                    b.Property<long>("AmenityBookingId")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("HotelBackend.Models.Card", b =>
                {
                    ...
                    b.HasIndex(new[] { "GuestId" }, "card_guest_id_key")
                        .IsUnique();
            ...
            modelBuilder.Entity("HotelBackend.Models.RoomComfort", b =>
                {
                    b.Property<long>("RoomId")
                        .HasColumnType("bigint")
                        .HasColumnName("room_id");

                    b.Property<long>("ComfortId")
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("HotelBackend.Models.AmenityBooking", b =>
                {
                    ...
                    b.HasOne("HotelBackend.Models.Employee", "Employee")
                        .WithMany("AmenityBookings")
            ...
            modelBuilder.Entity("HotelBackend.Models.Card", b =>
                {
                    ...
                    b.HasOne("HotelBackend.Models.Guest", "Guest")
                        .WithOne("Card")
                        .HasForeignKey("HotelBackend.Models.Card", "GuestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("HotelBackend.Models.Employee", b =>
                {
                    ...
                    b.HasOne("HotelBackend.Models.WorkSchedule", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("HotelBackend.Models.Guest", b =>
                {
                    b.HasOne("HotelBackend.Models.Client", "Client")
                        .WithOne("Guest")
                        .HasForeignKey("HotelBackend.Models.Guest", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("HotelBackend.Models.Hotel", b =>
                {
                    b.HasOne("HotelBackend.Models.HotelType", "HotelType")
                        .WithMany("Hotels")
            ...
            modelBuilder.Entity("HotelBackend.Models.HotelReview", b =>
                {
                    ...
                    b.HasOne("HotelBackend.Models.RoomBooking", "RoomBooking")
                        .WithOne("HotelReview")
                        .HasForeignKey("HotelBackend.Models.HotelReview", "RoomBookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("HotelBackend.Models.RoomComfort", b =>
                {
                    b.HasOne("HotelBackend.Models.Comfort", "Comfort")
                        .WithMany("RoomComforts")
